...
namespace Utilities
{
    ...
    public class AuthManager : IDisposable
    {
        ...
        //TODO:Enter your AAD Tenant Id or FQDN
        private const string tenant = "yourtenantdomain_or_id";
        private const string tokenEndpoint = "https://login.microsoftonline.com/"+tenant+"/oauth2/token";

        //TODO:Enter Client ID for the application registered in your AAD tenant.
        private const string defaultAADAppId = "enter app client id";
